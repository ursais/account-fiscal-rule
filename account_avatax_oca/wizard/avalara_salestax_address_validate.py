    ...
    def accept_valid_address(self):
        ...
        if active_id:
            ...
            vals = {
                ...
                "city": self.city,
                "zip": self.zip,
                "state_id": Partner.get_state_from_code(self.state, self.country) and Partner.get_state_from_code(self.state, self.country).id or False,
                "country_id": Partner.get_country_from_code(self.country) and Partner.get_country_from_code(self.country).id or False,
